...
$(function() {
  var role_permissions_tree = 'role_permissions_tree'
  var zTree;
  var demoIframe;
  ...
  var setting = {
    ...
    callback: {
      onCheck: function(event,  tree_id, tree_node) {
        ...
        ajax({
           url:  $("#assign_permissions_url").val(),
           type: "post",
           dataType: "text",
      ...
      beforeClick: function(treeId, treeNode) {
        var zTree = $.fn.zTree.getZTreeObj(role_permissions_tree);
  ...
  var zNodes = JSON.parse($("#permissions").val());
  var t = $("#"+role_permissions_tree);
